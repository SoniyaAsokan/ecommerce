...
Select Supplier   : <form:select path="supplier.supplierId">	
<c:forEach items="${suppliers}" var="s"><%--model.addAttribute("suppliers",suppliers), items refers the model attribute categories --%>
